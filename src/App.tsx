      ...
      {React.createElement("spline-viewer", {
        ...
        style: {
          transform: isMobile
            ...
            : `scale(${1.2 + scrollY * 0.0005}) rotateX(${
                mousePosition.y * 0.1
  ...
  return (
    <div className="h-screen text-slate-800 relative overflow-hidden bg-gradient-to-br from-blue-50 to-blue-100">
      ...
      >
        <div
          className={`${
            isMobile ? "h-16 px-3" : "h-20 px-6 md:px-8"
        ...
        >
          ...
          <div className="flex items-center">
            <motion.button
              ...
              } rounded-lg font-medium transition-all duration-300 flex items-center space-x-2 shadow-lg border border-gray-600 text-yellow-100`}
        ...
        >
          <motion.div
            className={`bg-gray-800 rounded-2xl ${
              isMobile ? "p-6 mx-4 max-w-sm" : "p-8 max-w-md mx-4"
            } w-full shadow-2xl border border-gray-600`}
          ...
          >
            ...
            <motion.button
              ...
              } rounded-lg font-medium transition-all duration-300 border border-gray-600`}
              whileHover={{ scale: 1.02 }}
              whileTap={{ scale: 0.98 }}
            >
              Close
